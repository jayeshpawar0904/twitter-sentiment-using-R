...
shinyServer(function(input, output) {
   ...
   TweetFrame<-function(twtList)
  {
   ...
   pos.words = scan('C:/Users/kumar/Desktop/Twitter-Sentiment-Analysis-R-Tutorials-master/positive-words.txt', what='character',comment.char =';') #Make sure you edit the location
   neg.words = scan('C:/Users/kumar/Desktop/Twitter-Sentiment-Analysis-R-Tutorials-master/negative-words.txt',what='character',comment.char =';')
